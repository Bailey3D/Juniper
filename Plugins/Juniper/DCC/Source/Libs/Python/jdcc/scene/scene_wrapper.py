...
class SceneWrapper(juniper.types.wrappers.type_wrapper.TypeWrapper):
    ...
    def _get_materials(self):
        ...
        for i in substance_painter.textureset.all_texture_sets():
            output.append(jdcc.material.MaterialWrapper(i))
        return output
    ...
    def __get_objects(self):
        ...
        for i in pymxs.runtime.objects:
            node = jdcc.scene.object_wrapper.ObjectWrapper(i)
            output.append(node)
        return output
    ...
    def __get_selection_sets(self):
        ...
        for i in pymxs.runtime.selectionSets:
            output.append(jdcc.scene.selection_set_wrapper.SelectionSetWrapper(i))
        return output