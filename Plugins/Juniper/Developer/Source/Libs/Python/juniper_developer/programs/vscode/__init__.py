...
def code_workspace_template_path():
    ...
    """
    return os.path.join(juniper.paths.root(), "Config\\Programs\\VSCode\\code_workspace_template.json")
...
def generate_code_workspace():
    ...
    with open(code_workspace_path(), "w") as f:
        ...
        f.write("// Any juniper global settings should be added to `//config/Programs/VSCode/code_workspace_template.json`\n")
