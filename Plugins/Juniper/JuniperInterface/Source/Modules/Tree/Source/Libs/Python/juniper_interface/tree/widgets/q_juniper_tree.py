...
from juniper_interface.tree.widgets import q_tree_group
from juniper_interface.tree.config_manager import ConfigManager
    ...
    def __update_search_entries(self, *args):
        ...
        for macro in juniper.engine.JuniperEngine().tools:
            if(any((
                ...
                search_string in macro.group.lower(),
                search_string in macro.parent_category.lower()
            ))):
